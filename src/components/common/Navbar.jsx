...
const Navbar = () => {
  ...
  const fetchSublinks = async () => {
    try {
      ...
      console.log("This is the data of sublinks", result.data.allCategories);
    ...
    <div className="border-b border-white bg-white  ">
      <div className="flex w-11/12 max-w-maxContent items-center justify-between mx-auto py-2 ">
                  ...
                  <li key={index}>
                    {element.title === "Catalog" ? (
                      <div className="relative cursor-pointer group ">
                        <p className="text-black font-normal text-base py-1 px-3 flex items-center gap-1 ">
                          {element.title}
                          <IoIosArrowDown />
                        </p>
        ...
        <div className=" flex flex-row gap-5 items-center ">
          ...
          {token === null && (
            <Link to={"/login"}>
              <button className="rounded-lg border py-2 px-3 border-[#FFFF00] bg-[#FFFF00] font-medium text-base text-black transition duration-300 ease-in-out hover:bg-[#002868] hover:border-[#002868]  hover:text-white">
                Log in
              </button>
            </Link>
          )}
          ...
          {token === null && (
            <Link to={"/signup"}>
              <button className="rounded-lg border py-2 px-3 border-richblack-700 bg-white font-medium text-base text-black hover:bg-[#002868] hover:border-[#002868]  hover:text-white">
                Sign up
              </button>
            </Link>
          )}
